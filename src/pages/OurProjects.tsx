...
const STATIC_PROJECTS: Project[] = [
  {
    ...
    description:
      'Custom high-performance websites built with Next.js for restaurants, real estate, and corporate brands.',
    ...
    mediaItems: [
      {
        id: 1,
        mediaType: 'video',
        mediaUrl: 'https://www.youtube.com/watch?v=REPLACE_VIDEO_ID_1',
      },
    ],
  },
  {
    ...
    description:
      'Scalable cloud-native web applications and enterprise SaaS platforms with secure API integrations.',
    ...
    mediaItems: [
      {
        id: 2,
        mediaType: 'video',
        mediaUrl: 'https://www.youtube.com/watch?v=REPLACE_VIDEO_ID_2',
      },
    ],
  },
  {
    ...
    description:
      'High-performance native and cross-platform mobile apps built with Swift, Kotlin, and React Native.',
    ...
    mediaItems: [
      {
        id: 3,
        mediaType: 'video',
        mediaUrl: 'https://www.youtube.com/watch?v=REPLACE_VIDEO_ID_3',
      },
    ],
  },
  {
    ...
    description:
      'Cinematic VFX compositing, motion graphics, and post-production work for film and commercial projects.',
    category: 'vfx',
    ...
    mediaItems: [
      {
        id: 4,
        mediaType: 'video',
        mediaUrl: 'https://www.youtube.com/watch?v=REPLACE_VIDEO_ID_4',
      },
    ],
  },
  {
    ...
    description:
      'Data-driven social media and PPC campaigns generating measurable ROI for e-commerce and SaaS brands.',
    ...
    mediaItems: [
      {
        id: 5,
        mediaType: 'video',
        mediaUrl: 'https://www.youtube.com/watch?v=REPLACE_VIDEO_ID_5',
      },
    ],
  },
  {
    ...
    description:
      'Immersive game environments, UI systems, and interactive mechanics designed for PC and mobile platforms.',
    ...
    mediaItems: [
      {
        id: 6,
        mediaType: 'video',
        mediaUrl: 'https://www.youtube.com/watch?v=REPLACE_VIDEO_ID_6',
      },
    ],
  },
  {
    ...
    description:
      'Character animation, product visualisation, and architectural walkthroughs rendered in Blender and Maya.',
    ...
    mediaItems: [
      {
        id: 7,
        mediaType: 'video',
        mediaUrl: 'https://www.youtube.com/watch?v=REPLACE_VIDEO_ID_7',
      },
    ],
  },
];
      ...
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className="mt-20 flex items-center justify-center">
          <motion.button
            whileHover={{
              scale: 1.05,
              boxShadow: '0 20px 25px -5px rgb(40 189 183 / 0.3)',
            }}
            whileTap={{ scale: 0.95 }}
